...
```toml
[dependencies]
frozen-core = { version = "0.0.16", features = ["error"] }
```
...
```toml
[dependencies]
frozen-core = { version = "0.0.16", features = ["hints"] }
```
...
```toml
[dependencies]
frozen-core = { version = "0.0.16", features = ["ffile"] }
```
...
```toml
[dependencies]
frozen-core = { version = "0.0.16", features = ["fmmap"] }
```
...
```toml
[dependencies]
frozen-core = { version = "0.0.16", features = ["crc32"] }
```
...
```toml
[dependencies]
frozen-core = { version = "0.0.16", features = ["bpool"] }
```
...
```toml
[dependencies]
frozen-core = { version = "0.0.16", features = ["mpscq"] }
```
...
```toml
[dependencies]
frozen-core = { version = "0.0.16", features = ["fpipe"] }
```
