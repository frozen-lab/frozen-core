...
```toml
[dependencies]
frozen-core = { version = "0.0.15", features = ["error"] }
```
...
```toml
[dependencies]
frozen-core = { version = "0.0.15", features = ["hints"] }
```
...
```toml
[dependencies]
frozen-core = { version = "0.0.15", features = ["ffile"] }
```
...
```toml
[dependencies]
frozen-core = { version = "0.0.15", features = ["fmmap"] }
```
...
```toml
[dependencies]
frozen-core = { version = "0.0.15", features = ["crc32"] }
```
...
```toml
[dependencies]
frozen-core = { version = "0.0.15", features = ["bpool"] }
```
...
```toml
[dependencies]
frozen-core = { version = "0.0.15", features = ["mpscq"] }
```
...
```toml
[dependencies]
frozen-core = { version = "0.0.15", features = ["fpipe"] }
```
